...
import kotlinx.android.synthetic.main.recyclet_favorite_single_row.*
...
class FavoriteRecyclerAdapter(val context: Context, private val bookList:List<BookEntity>):RecyclerView.Adapter<FavoriteRecyclerAdapter.FavoriteViewHolder>() {
    override fun onCreateViewHolder(
        ...
        val view =LayoutInflater.from(parent.context).inflate(R.layout.recyclet_favorite_single_row,parent,false)
